 ...
 * @author Adam Waite
 * @version $Rev: 1935 $, $Date: 2013-04-12 11:26:27 -0700 (Fri, 12 Apr 2013) $
 *
 */
public class RandomNeighborPicker extends CoordinatePicker {
    protected final int max_distance;

    private RandomNeighborPicker(int max_row, int max_col,
    ...
    public RandomNeighborPicker(boolean exclude_current, int max_distance,
                                RandomNumberUser rng)
    {
        this(0, 0, exclude_current, null, max_distance, rng);
    }


    public RandomNeighborPicker(boolean exclude_current,
                                CoordinateProvider provider,
                                int max_distance, RandomNumberUser rng)
    {
        this(0, 0, exclude_current, provider, max_distance, rng);
    }
    ...
    public String getType() {
        return new String("local_dist=" + max_distance);
    }

    @Override
    public String toString() {
        return new String("RandomNeighborPicker, max_dist="+ max_distance + 
                          ", seed=" + rng.getSeed());
    }
}
