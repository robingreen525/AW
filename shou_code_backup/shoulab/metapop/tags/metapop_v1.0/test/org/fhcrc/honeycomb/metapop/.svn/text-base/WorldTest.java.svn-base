...
public class WorldTest {
    ...
    public void distributeTest() {
        ...
        double migrant_size = initial_population.getSize() * migration_rate; 
        double remaining = initial_population.getSize() - migrant_size;
        ...
        assertEquals("wrong migrant size",
                     migrant_size, migrants.getSize(), 0.0);

        assertEquals("wrong remaining size", remaining,
                     occupied_location.populationSize(), 0.0);
        ...
        assertEquals("wrong new size", migrant_size,
                     newly_occupied.populationSize(), 0.0);
        ...
        double expected_after_migrants = 
            emigration_location2.populationSize() + migrant_size;
        world.distribute(new_location2);
        assertEquals("wrong size after mixing", expected_after_migrants,
                     emigration_location2.populationSize(), 0.0);
    }
