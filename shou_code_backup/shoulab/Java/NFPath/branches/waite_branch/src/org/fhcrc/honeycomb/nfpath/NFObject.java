...
/** NFObject is intended to represent the file information generated
...
public class NFObject {
   ...
   * @return the name of the <code>NFObject</code>.
   */
  ...
  public NFObject(File path) {
    ...
    // The path passed to NFObject has the following structure:
    ...
    // Open the info file whose name matches the path passed to NFObject.
