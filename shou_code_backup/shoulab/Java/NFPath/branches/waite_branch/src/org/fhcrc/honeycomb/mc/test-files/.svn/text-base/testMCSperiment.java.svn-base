...
public class testMCSperiment {
  public static void main(String[] args) {
    try {
      MCSperiment experiment = new MCSperiment(new File(args[0]));
      System.out.println(
          "The project path is:\n\t" + 
