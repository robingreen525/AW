 ...
 * @author Adam Waite
 * @version $Id: SubpopulationTest.java 2183 2013-06-27 23:30:43Z ajwaite $
 *
 */
public class SubpopulationTest {
    ...
    private double release_rate = 0.0;
    private double death_rate = 0.1;
    private double saturation_death_rate = 0.5;
    ...
    @Before
    public void setUp() {
        sub = new Subpopulation(initial_size, gamma, release_rate, 
                                saturation_death_rate, fc, id, rng);
    }
