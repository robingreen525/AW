 ...
 *
 * @author Adam Waite
 * @version $Id: AdaptiveRace.java 2183 2013-06-27 23:30:43Z ajwaite $
 *
 */
public abstract class AdaptiveRace {
    ...
    private double cheat_to_coop_mutation_rate = 0;
    private double coop_to_cheat_mutation_rate = 0;
    private double saturation_death_rate = 0.05;
    ...
    private void parseArgs(String args[]) {
        ...
        randomize = Boolean.parseBoolean(args[15]);
        population_seed = Long.parseLong(args[16]);
        location_seed = Long.parseLong(args[17]);
        migration_seed = Long.parseLong(args[18]);
        mutation_seed = Long.parseLong(args[19]);
        env_change_seed = Long.parseLong(args[20]);
        hours = (int) Double.parseDouble(args[21]);
        save_every_dbl = Double.parseDouble(args[22]);
