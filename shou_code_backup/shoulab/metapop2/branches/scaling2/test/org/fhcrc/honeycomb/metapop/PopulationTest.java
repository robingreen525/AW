 ...
 * @author Adam Waite
 * @version $Id: PopulationTest.java 2241 2013-08-01 22:02:26Z ajwaite $
 *
 */
public class PopulationTest {
    ...
    public void limitedNutrientGrowth() {
        ...
        double residual = 0.0;
        for (Subpopulation subpop:limited_half_pop.getSubpopulations()) {
            residual += subpop.getUnfinishedCells();
        }
        assertEquals("biomass conversion wrong",
                     new_size + residual - size, resource - new_resource, 0.0);
    }
