 ...
 * @author Adam Waite
 * @version $Id: Population.java 2246 2013-08-04 23:52:28Z ajwaite $
 *
 */
public class Population {
    ...
    // Getters
    /** gets the ODE solver */
    public ConsumptionODE getSolver() { return ode; }
    ...
    public void grow(double timestep_length) {
        ...
        // Run the ODE
        ode = new ConsumptionODE(this);
        ode.integrate(timestep_length);
        resource = ode.getAverageResource();
        ...
        for (Subpopulation subpop:subpopulations) {
            ...
            int births = 0;
            if (under_capacity) births = subpop.getBirths(resource);
    ...
    public String toString() {
        ...
        report.append(spacer).append(ode.toString());
        for (Subpopulation sub:subpopulations) {
