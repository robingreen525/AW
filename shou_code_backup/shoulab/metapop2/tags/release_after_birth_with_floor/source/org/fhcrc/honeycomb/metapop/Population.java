 ...
 * @author Adam Waite
 * @version $Id: Population.java 2228 2013-07-19 18:18:48Z ajwaite $
 *
 */
public class Population {
    ...
    public void grow() {
        ...
        for (int i=0; i<n_subpopulations; i++) {
            ...
            double released = subpop.getReleaseRate()*subpop.getSize(); 
            double consumed = subpop.getGamma()*births;
