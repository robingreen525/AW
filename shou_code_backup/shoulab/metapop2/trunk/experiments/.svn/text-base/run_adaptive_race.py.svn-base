...
class PeriodicDilution99_1e1(AdaptiveRace):
    def __init__(self):
        super(PeriodicDilution99_1e1, self).__init__()
        self.program = "PeriodicDilution99_1e1AR"
        self.frac_occupied = [0.5]
        self.mutant_freqs = [0, 2e-5, 2e-4, 2e-3]
        self.output = 'periodic_dilution/frac=0.99_hrs=1.00e+01'

class PeriodicDilution99_1e2(AdaptiveRace):
    def __init__(self):
        super(PeriodicDilution99_1e2, self).__init__()
        self.program = "PeriodicDilution99_1e2AR"
        self.frac_occupied = [0.5]
        self.mutant_freqs = [0, 2e-5, 2e-4, 2e-3]
        self.output = 'periodic_dilution/frac=0.99_hrs=1.00e+02'

class PeriodicDilution99_1e3(AdaptiveRace):
    def __init__(self):
        super(PeriodicDilution99_1e3, self).__init__()
        self.program = "PeriodicDilution99_1e3AR"
        self.frac_occupied = [0.5]
        self.mutant_freqs = [0, 2e-5, 2e-4, 2e-3]
        self.output = 'periodic_dilution/frac=0.99_hrs=1.00e+03'

class PeriodicDilution99_1e4(AdaptiveRace):
    def __init__(self):
        super(PeriodicDilution99_1e4, self).__init__()
        self.program = "PeriodicDilution99_1e4AR"
        self.frac_occupied = [0.5]
        self.mutant_freqs = [0, 2e-5, 2e-4, 2e-3]
        self.output = 'periodic_dilution/frac=0.99_hrs=1.00e+04'
...
class ReleaseTest(AdaptiveRaceParams):
    def __init__(self):
        ...
        self.coop_freq = [1]
        self.mutant_freqs = [1]
        self.coop_release = [x + y/10.0 for x in range(10,20) for y in range(10)]
